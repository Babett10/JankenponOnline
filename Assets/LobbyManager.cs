...
public class LobbyManager : MonoBehaviourPunCallbacks
{
    ...
    public override void OnMasterClientSwitched(Photon.Realtime.Player newMastereClient)
    {
        //atur start game button
        SetStartGameButton();
    }
    ...
    {
        // tampilkan hanya di mastr client
    ...
    private void UpdatePlayerList()
    {
        ...
        // start game hanya bisa diklik keetika jumlah pemain tertentu
        SetStartGameButton();
    }
