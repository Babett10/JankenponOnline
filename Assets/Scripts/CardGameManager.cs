...
public class CardGameManager : MonoBehaviour, IOnEventCallback
{
    ...
    public PlayerStats deafultPlayerStats = new PlayerStats
    {
        MaxHealth = 100,
        RestoreValue = 5,
        DamageValue = 10
    ...
    private void Start()
    {
        ...
        P1.SetStats(deafultPlayerStats,true);
        P2.SetStats(deafultPlayerStats,true);
        P1.IsReady = true;
        P2.IsReady = true;
    }
